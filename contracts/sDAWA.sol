...
contract sDAWAToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked DAWA", "sDAWA", 9) ERC20Permit() {
    ...
    /**
        @notice increases sDAWA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sDAWA
