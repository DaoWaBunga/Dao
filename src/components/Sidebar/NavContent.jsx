...
import { ReactComponent as PresaleIcon } from "../../assets/icons/bank.svg";
        ...
        <div className="dapp-menu-top">
          <Box className="branding-header">
            <Link href="/" target="_blank">
              ...
              />
              <div className="wallet-link f-32">DAOWABUNGA</div>
            </Link>
            {address && (
          ...
          <div className="dapp-menu-links">
            <div className="dapp-nav" id="navbarNav">
              ...
              >
                <Typography variant="h6">
                  <SvgIcon color="primary" viewBox="0 0 24 24" component={PresaleIcon} />
                  Presale
                </Typography>
              </Link>
